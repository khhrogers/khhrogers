const stocks = [
  ...
  // Function to loop through stocks and return their name and lastPrice
  function getStocksNameAndPrice() {
  ...
  // Export the getStocksNameAndPrice function
  export { getStocksNameAndPrice };
  // Export the stocks array for use in app.js
